...
class C2paAudio:
    def __init__(self, path: str | None = None):
        ...
        self._lib = lib
        lib.c2pa_audio_sign_wav.restype = ctypes.c_int
        lib.c2pa_audio_sign_wav.argtypes = [
        ...
        lib.c2pa_audio_verify_wav.restype = ctypes.c_int
        lib.c2pa_audio_verify_wav.argtypes = [ctypes.c_char_p, ctypes.c_size_t]
    ...
    def sign_wav(self, wav: bytes, cert_pem: str | None = None, key_pem: str | None = None) -> bytes:
        ...
        rc = self._lib.c2pa_audio_sign_wav(
            wav, len(wav),
        ...
        if rc != 0:
            raise RuntimeError(f"c2pa_audio_sign_wav failed (rc={rc})")
        try:
    ...
    def verify_wav(self, wav: bytes) -> VerifyResult:
        f = self._lib.c2pa_audio_verify_wav(wav, len(wav))
